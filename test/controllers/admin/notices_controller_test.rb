...
class Admin::NoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_notice" do
    assert_difference('Admin::Notice.count') do
      post admin_notices_url, params: { admin_notice: { description: @admin_notice.description, status: @admin_notice.status, title: @admin_notice.title } }
    end
  ...
  test "should update admin_notice" do
    patch admin_notice_url(@admin_notice), params: { admin_notice: { description: @admin_notice.description, status: @admin_notice.status, title: @admin_notice.title } }
