...
class Admin::LanguagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_language" do
    assert_difference('Admin::Language.count') do
      post admin_languages_url, params: { admin_language: { attachment: @admin_language.attachment, name: @admin_language.name, status: @admin_language.status } }
    end
  ...
  test "should update admin_language" do
    patch admin_language_url(@admin_language), params: { admin_language: { attachment: @admin_language.attachment, name: @admin_language.name, status: @admin_language.status } }
