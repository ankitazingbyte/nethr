...
class Admin::TicketsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_ticket" do
    assert_difference('Admin::Ticket.count') do
      post admin_tickets_url, params: { admin_ticket: { admin_employee_id: @admin_ticket.admin_employee_id, message: @admin_ticket.message, subject: @admin_ticket.subject } }
    end
  ...
  test "should update admin_ticket" do
    patch admin_ticket_url(@admin_ticket), params: { admin_ticket: { admin_employee_id: @admin_ticket.admin_employee_id, message: @admin_ticket.message, subject: @admin_ticket.subject } }
