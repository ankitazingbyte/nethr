...
class Admin::EventsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_event" do
    assert_difference('Admin::Event.count') do
      post admin_events_url, params: { admin_event: { all_day: @admin_event.all_day, description: @admin_event.description, starttime: @admin_event.starttime, title: @admin_event.title } }
    end
  ...
  test "should update admin_event" do
    patch admin_event_url(@admin_event), params: { admin_event: { all_day: @admin_event.all_day, description: @admin_event.description, starttime: @admin_event.starttime, title: @admin_event.title } }
