...
class AwardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create award" do
    assert_difference('Award.count') do
      post awards_url, params: { award: { cash_price: @award.cash_price, gift: @award.gift, month: @award.month, name: @award.name, year: @award.year } }
    end
  ...
  test "should update award" do
    patch award_url(@award), params: { award: { cash_price: @award.cash_price, gift: @award.gift, month: @award.month, name: @award.name, year: @award.year } }
