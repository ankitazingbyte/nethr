...
class DesignationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create designation" do
    assert_difference('Designation.count') do
      post designations_url, params: { designation: { department_id: @designation.department_id, name: @designation.name } }
    end
  ...
  test "should update designation" do
    patch designation_url(@designation), params: { designation: { department_id: @designation.department_id, name: @designation.name } }
