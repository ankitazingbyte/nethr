...
class HolidaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create holiday" do
    assert_difference('Holiday.count') do
      post holidays_url, params: { holiday: { date: @holiday.date, occasion: @holiday.occasion } }
    end
  ...
  test "should update holiday" do
    patch holiday_url(@holiday), params: { holiday: { date: @holiday.date, occasion: @holiday.occasion } }
